<?php
	class ENOEXT_EltakoShutter extends IPSModule
	{
		#================================================================================================
		...
		#================================================================================================
		{
			...
			if (!IPS_VariableProfileExists('ShutterMoveStop.ENOEXT')) {
			...
			if (!IPS_VariableProfileExists('ShutterMoveTime.ENOEXT')) {
				IPS_CreateVariableProfile('ShutterMoveTime.ENOEXT', 2);
				IPS_SetVariableProfileIcon('ShutterMoveTime.ENOEXT', 'Clock');
				IPS_SetVariableProfileDigits('ShutterMoveTime.ENOEXT', 1);
				IPS_SetVariableProfileText('ShutterMoveTime.ENOEXT', '', 's');
			}
		}
